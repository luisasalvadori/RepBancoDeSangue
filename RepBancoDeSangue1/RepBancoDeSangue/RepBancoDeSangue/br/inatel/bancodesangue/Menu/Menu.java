...
public class Menu {
    ...
    private Arquivos arquivoService;
    ...
    public Menu() {
        ...
        banco = new BancoSangue("Banco Vida");
        arquivoService = new Arquivos("estoque_banco_sangue.csv");
    ...
    private void carregarDadosIniciais() {
        try {
            Enfermeiro enfermeiro = new Enfermeiro("Ana", 32, "111.111.111-11", "feminino", "Enfermeira", "ENF001", "COREN-12345");
            Biomedico biomedico = new Biomedico("Carlos", 40, "222.222.222-22", "masculino", "Biomédico", "BIO001", "CRBio-98765");
            Administrador administrador = new Administrador("Marina", 35, "333.333.333-33", "feminino", "Administradora", "ADM001");
            Doador doador = new Doador("João", 25, "444.444.444-44", "masculino", "O+", 80.0, null, 0);
            Paciente paciente = new Paciente("Maria", 28, "555.555.555-55", "feminino", "A+", 9, 2, 0, "Cirurgia de emergência");
    ...
    private void menuDoacoesSolicitacoes() {
        int opcao;
        do {
            System.out.println("\n===== MENU DE DOAÇÕES E SOLICITAÇÕES =====");
    ...
    private void cadastrarDoador() {
        ...
        try {
            Doador doador = new Doador(nome, idade, cpf, sexo, tipoS, peso, ultimaDoacao, ultimaDoacao == null ? 0 : 1);
            doadores.add(doador);
    ...
    private void salvarEstoque() {
        try {
            arquivoService.salvarEstoque(banco);
        } catch (IOException e) {
